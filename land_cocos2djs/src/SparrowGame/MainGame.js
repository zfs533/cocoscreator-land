...
var MainGameLayer = cc.Layer.extend(
	{
		...
		showItemBox : function()
		{
			...
			if ( this.deskLayer)
			{
				this.deskLayer.taskTxt.setString(RandomTaskDescribe[RandomTaskAttending.id]);
			}
		...
		{
			this.addChild(new chatText(isFace, charDirection, color, chatContent), 10000);
		},
		//游戏开始，隐藏结算金币显示
...
var MainGameScene = rootScene.extend({
	...
	onExit: function ()
	{
		...
		cc.log("============================= 退出场景");
		cc.spriteFrameCache.removeSpriteFramesFromFile("res/landlord/cocosOut/card/card.plist");
		cc.spriteFrameCache.removeSpriteFramesFromFile("res/landlord/cocosOut/card/cardSmall.plist");
		cc.spriteFrameCache.removeSpriteFramesFromFile("res/landlord/cocosOut/desk/desk01.plist");
		cc.spriteFrameCache.removeSpriteFramesFromFile("res/landlord/cocosOut/desk/desk02.plist");
		cc.spriteFrameCache.removeSpriteFramesFromFile("res/landlord/laizi/laizi.plist");
